...
export const HULA_MARKETS: Market[] = [
  {
    ...
    type: '3way',
    title: 'Argentina vs France — Semi-final',
    subtitle: 'MetLife Stadium · Jul 14, 8:00 AM PHT',
    outcomes: [
      { id: 'home', label: 'Argentina',   sub: 'HOME', price: 46, prev: 44 },
      { id: 'draw', label: 'Draw (90′)',  sub: 'DRAW', price: 27, prev: 28 },
      { id: 'away', label: 'France',      sub: 'AWAY', price: 27, prev: 28 },
    ],
    volume: 512500, liquidity: 152800,
    movers: {
      home: [41, 42, 44, 45, 45, 46, 46, 46],
      draw: [30, 29, 28, 28, 27, 27, 27, 27],
      away: [29, 29, 28, 27, 28, 27, 27, 27],
    },
    closes: 'Closes at kickoff · Jul 14, 8:00 AM',
...
export const HULA_POSITIONS_OPEN: OpenPosition[] = [
  ...
  {
    id: 'p2', marketId: 'WC26-ARG-FRA-SF',
    market: 'Argentina vs France',
    outcome: 'Argentina (HOME)', shares: 100, avgPrice: 44, currentPrice: 46,
    cost: 4400, value: 4600, status: 'open',
  },
]
