...
export const DAILY_SAMPLE: Match = {
  ...
  timeline: [
    ...
    { atMs: 13_000, gameClock: '08:00 AM', eventId: 'd-class-susp',    description: 'DepEd suspends NCR classes' },
    ...
    { atMs: 54_000, gameClock: '04:00 PM', eventId: 'd-usdphp-low',    description: 'USD/PHP closes at 55.87' },
    { atMs: 62_000, gameClock: '05:30 PM', eventId: 'd-pba-tonight',   description: 'Ginebra-SMB tipoff at 7' },
    ...
    { atMs: 85_000, gameClock: '10:00 PM', eventId: 'd-btc-100k',      description: 'BTC closes $102k' },
