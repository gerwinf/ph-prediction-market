...
/* ────────────────────────────────────────────────────────────────────────
 * PBA Commissioner's Cup event pool — calibrated to current form
 * (semis observation, Sun May 24).
 *
 * Sunday cross-reference: Ginebra 103 RoS 98 (Thompson 25p; RoS import
 * M. Jones 20p/13r; Tiongson + Nambatac active). TNT 77 Meralco 75 (low
 * scoring, defensive grind; Mikey not the offensive engine he was).
 *
 * Calibration moves:
 *   - Thompson scoring elevated from rare-triple-dub to common-20+
 *   - Brownlee 25+ pushed to uncommon (was common); kept dunk/tech
 *   - Added named RoS players: Tiongson, Nambatac, Norwood, Mocon
 *   - Added Castro for TNT (he's been the steadier veteran)
 *   - Dropped Belga rebound (quiet through semis)
 *   - Mikey moved to uncommon scoring; kept 3-ball as flavor
 *   - More team-flow cells (runs, lead changes) — fire reliably regardless
 *     of which star carries
 *   - More import-agnostic cells ("any import 25+", "any starter fouls
 *     out") so cards still light when actual scorers don't match guess
 *
 ...
 * Taglish labels lean masa. Re-tune per series on the day if Jade flags
 * rotation gaps.
 * ──────────────────────────────────────────────────────────────────── */

export const CANDIDATE_EVENTS: GameEvent[] = [
  // ───── Ginebra ─────
  { id: 'thompson-20',         label: 'Scottie Thompson scores 20+',     category: 'scoring',  rarity: 'common' },
  { id: 'thompson-steal',      label: 'Scottie Thompson steal → fastbreak', category: 'play', rarity: 'common' },
  { id: 'thompson-clutch',     label: 'Thompson clutch basket Q4',       category: 'scoring',  rarity: 'uncommon' },
  { id: 'thompson-trip',       label: 'Scottie Thompson triple-dub',     category: 'scoring',  rarity: 'rare' },
  { id: 'brownlee-25',         label: 'Brownlee scores 25+',             category: 'scoring',  rarity: 'uncommon' },
  ...
  { id: 'aguilar-block',       label: 'Japeth Aguilar block',            category: 'play',     rarity: 'uncommon' },

  // ───── Rain or Shine ─────
  { id: 'ros-import-20',       label: 'RoS import (M. Jones) scores 20+', category: 'scoring', rarity: 'common' },
  { id: 'ros-import-double',   label: 'RoS import double-double',         category: 'scoring', rarity: 'common' },
  { id: 'tiongson-3ball',      label: 'Tiongson 3+ threes',              category: 'scoring',  rarity: 'common' },
  { id: 'nambatac-15',         label: 'Nambatac scores 15+',             category: 'scoring',  rarity: 'common' },
  { id: 'norwood-clutch',      label: 'Norwood clutch shot Q4',          category: 'scoring',  rarity: 'uncommon' },
  { id: 'mocon-energy',        label: 'Mocon hustle play (steal/dive)',  category: 'play',     rarity: 'common' },

  // ───── TNT ─────
  { id: 'mikey-3ball',         label: 'Mikey Williams 3+ threes',        category: 'scoring',  rarity: 'uncommon' },
  { id: 'mikey-20',            label: 'Mikey Williams scores 20+',       category: 'scoring',  rarity: 'uncommon' },
  ...
  { id: 'castro-vet',          label: 'Jayson Castro veteran assist',    category: 'play',     rarity: 'common' },
  { id: 'tnt-import-20',       label: 'TNT import scores 20+',           category: 'scoring',  rarity: 'common' },
  { id: 'tnt-import-double',   label: 'TNT import double-double',        category: 'scoring',  rarity: 'common' },
  ...
  { id: 'banchero-grind',      label: 'Banchero 10+ rebounds',           category: 'scoring',  rarity: 'common' },
  { id: 'meralco-import-20',   label: 'Meralco import scores 20+',       category: 'scoring',  rarity: 'common' },
  ...
  // ───── Import-agnostic carriers (light when import goes off, w/o naming) ─────
  { id: 'any-import-25',       label: 'Sino mang import, 25+ points',    category: 'scoring',  rarity: 'common' },
  { id: 'any-import-double',   label: 'Sino mang import, double-double', category: 'scoring',  rarity: 'common' },
  { id: 'import-vs-import',    label: 'Both imports scoring 20+',        category: 'scoring',  rarity: 'uncommon' },
  { id: 'local-leads-team',    label: 'Local leads team in scoring',     category: 'scoring',  rarity: 'uncommon' },
  ...
  { id: 'lead-changes-10',     label: '10+ lead changes',                category: 'flow',     rarity: 'uncommon' },
  { id: 'run-10-0',            label: '10-0 run by either team',         category: 'flow',     rarity: 'common' },
  ...
  { id: 'crowd-erupts',        label: 'Aaba ng arena (10s+ standing O)', category: 'flow',     rarity: 'uncommon' },
]
